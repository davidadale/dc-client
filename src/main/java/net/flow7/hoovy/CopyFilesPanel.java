...
public class CopyFilesPanel extends JPanel {
	...
	public CopyFilesPanel(){
        ...
        textLabel.setText("Getting ready to analyze drive");
    ...
    public void setSomething(int max){
        progressSent.setMaximum(max);
    }
    ...
    private JPanel getContentPanel() {            
        ...
        welcomeTitle.setText("Getting ready to analyze file for number of files available.");
